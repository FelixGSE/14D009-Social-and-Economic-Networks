...
We can't have the same Nash-Equilibria. The bigger the difference between $\alpha$ and $\beta$ is, the more unlikely it is to substain the initially appointed equilibria. Whichever of both is bigger will point to choosing more frequently option A or B.  
